...
def main():
    ...
    customer_cases_csv_filepath = "insight-synergy/insight-synergy/utils/data/customer_cases.csv"
    customer_info_csv_filepath = "insight-synergy/utils/data/customer_info.csv"
    customer_product_csv_filepath = "insight-synergy/insight-synergy/utils/data/customer_product.csv"
    product_info_csv_filepath = "insight-synergy/utils/data/product_info.csv"
